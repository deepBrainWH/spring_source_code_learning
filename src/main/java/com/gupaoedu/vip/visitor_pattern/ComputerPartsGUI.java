package com.gupaoedu.vip.visitor_pattern;
...
public class ComputerPartsGUI extends JFrame implements ItemListener {
	...
	private JPanel checkBoxPanel, choicePanel;
	String[] compParts = { "Case", "Motherboard", "Microprocessor", "Memory", "DriveController", "VideoCard", "Fan",
			"PowerSupply", "HardDiskDrive", "CDDrive", "DVDDevice", "Monitor", "Keyboard", "Mouse", "Assembly",
			"WholePC" };
